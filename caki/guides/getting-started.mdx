...
description: "Comece a desenvolver no Caki em minutos"
---
...
1. Leia a [Documentação de Arquitetura](/caki/architecture/overview)
2. Explore o [Design System](/caki/design-system/introduction)
3. Veja os [Guias de Desenvolvimento](/caki/guides/development)
4. Consulte a [API Reference](/caki/api/overview)
