---
title: "Tela de Editor"
description: "Documentação completa da tela de edição de fotos do Caki"
---
...
Veja mais em [Filtros](/caki/filters/overview).
...
Veja mais em [Widgets](/caki/widgets/overview).
